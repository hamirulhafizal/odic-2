...
// material-ui
import { Button, Checkbox, FormControlLabel, Grid, IconButton, Input, InputLabel, Stack, TextField, Typography } from '@mui/material';
...
export default function GalleryForm({ imageProperty, setPaymentData, handleNext, handleBack, setErrorIndex }) {
  ...
  //   formik.setFieldValue('coverImage', fileImg);
  // }, [fileObjects, fileImg]);

  // console.log('formik.values.image-->', formik.values.coverImage);
        ...
        <Grid container spacing={3}>
          ...
          <Grid item xs={12} md={6}>
            ...
            <label htmlFor="contained-button-file">
              ...
              {/* <Typography variant="body1">{formik.values.file}</Typography> */}
            </label>
